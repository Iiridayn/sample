...
class CS240Exception : public ObjectCount<CS240Exception> {
 protected:
  std::string message;
...
class InvalidArgumentException : public CS240Exception, public ObjectCount<InvalidArgumentException> {
 public:
...
class InvalidURLException : public CS240Exception, public ObjectCount<InvalidURLException> {
 public:
...
class IllegalStateException : public CS240Exception, public ObjectCount<IllegalStateException> {
 public:
...
class IOException : public CS240Exception, public ObjectCount<IOException> {
 public:
...
class NetworkException : public CS240Exception, public ObjectCount<NetworkException> {
 public:
...
class FileException : public CS240Exception, public ObjectCount<FileException> {
 public:
